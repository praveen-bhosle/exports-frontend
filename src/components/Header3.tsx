export const Header3 = ({ quality, setQuality }: { quality: string | null, setQuality: React.Dispatch<React.SetStateAction<string | null>> }) => {
    ...
    return (<div className='text-lg flex justify-center gap-2 bg-white dark:bg-black  w-[100%] '>
        <button className='rounded-2xl px-2 py-[2px] text-xs border-2 border-gray-400 ' style={{
        ...
        <button className='rounded-2xl border-2 border-gray-400 px-2 py-[2px] text-xs  '
            style={{
